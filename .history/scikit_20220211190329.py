...
# import inv_util_dataloader_scikit as util_dataloader_scikit  # noqa
...
if __name__ == '__main__':
    ...
    # X = np.concatenate([data['covariate'].squeeze(),
    #                     data['treatment']], axis=1)
    y = data['outcome']
    ...
    X_valid = np.concatenate([data['oh1f'], data['oh2f'], data['oh3f'],
                              data['oh4f'], data['ph'], data['tf'], data['treatment']], axis=1)
    # X_valid = np.concatenate([data['covariate'].squeeze(),
    #                           data['treatment']], axis=1)
