...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Val_XGB_single')
    parser.add_argument('--target', type=str, default='Val_XGB_single')
    parser.add_argument('--out', type=str, default='Val_XGB.csv')
    ...
    # dvalid = xgb.DMatrix(csr_matrix(X_valid), label=y_valid)
    ...
    # ypred = model.predict(dtrain,  iteration_range=(0, model.best_iteration))
