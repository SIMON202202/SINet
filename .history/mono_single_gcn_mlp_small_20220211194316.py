...
from model.single_model_gnn_mlp import GNN  # noqa
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', type=float, default=0.0,
                        help="alpha=0でmean, \infでmaxになるsmoothmax")
    ...
    # 特徴量
    parser.add_argument('--rep_hidden', type=str, default='40,40')  # 使う
    # バランス
    parser.add_argument('--out_hidden', type=str, default='200,200')  # 使う

    # 特徴量
    # parser.add_argument('--rep_hidden', type=str, default='10,10')  # 使う
    # バランス
    # parser.add_argument('--out_hidden', type=str, default='10,10')  # 使う
    ...
    if 'Linux' in platform.system():
        ...
        dirpath = '/Users/koh/Dropbox/work/data/2020/simulator_wide/shinkoku_wide/'

    args.dirpath = dirpath
    savepath = '%s/dataset_%d/guide%d/out/%s_a_%.1f_train_%.1f/' % (
        dirpath, args.expid, args.guide, args.traintest, args.a, args.trainprop)
    # savepath = '%s/dataset/guide%d/out/%s_a_%.1f/' % (
    #     dirpath, args.guide, args.traintest, args.a)
