...
from model.model_gnn_mlp import GNN  # noqa
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                        default="Inv-Hist2Cum-GCN-MLP-demo")
    ...
    # parser.add_argument('--hist2cum', type=str, default='False')
    ...
    # バランス
    parser.add_argument('--out_hidden', type=str, default='400,400')  # 使う
